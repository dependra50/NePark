...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        id=getIntent().getIntExtra("parkinglots",0);


        Retrieve fetch=new Retrieve();
        fetch.execute("");

     // Toast.makeText(getApplicationContext(),"the click id number is"+id,Toast.LENGTH_SHORT).show();
    ...
    public void onMapReady(GoogleMap googleMap) {
       ...
       /* mMap.setOnMapLongClickListener(new GoogleMap.OnMapLongClickListener() {
            ...
            public void onMapLongClick(LatLng latLng) {
                //reset marker when thera alreay two
                    ...
                    if(rs!=null)
                    {
                        ...
                        while(rs.next())
                        {
                                try {
                                    ...
                                    if((Integer)rs.getInt("id")==id){
                                        lat2=(double)rs.getDouble("latitude");
                                        lon2=(double)rs.getDouble("longitude");
                                        //j++;
        ...
        protected void onPostExecute(String s) {
            ...
            if(success==false){
                ...
                try {
                    ...
                    //Toast.makeText(getApplicationContext(),"Latitude="+lat2+"\nLongitude="+lon2,Toast.LENGTH_SHORT).show();
